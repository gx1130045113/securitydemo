...
/*    public static String scanner(String tip) {
    ...
    public static void main(String[] args) {
       ...
       // pc.setModuleName("discussPost");
       pc.setParent("com.example.securitydemo");
        pc.setEntity("domain");
        pc.setMapper("mapper");
      ...
      //  strategy.setSuperEntityColumns("id", "created_by", "created_name", "created_time", "updated_by","updated_name", "updated_time", "is_delete","version");
